          ...
          <div>
            ...
            <div className="divide-y divide-stone-200 dark:divide-stone-700 rounded-md border border-stone-200 dark:border-stone-700 overflow-hidden">
              {primarySkills.map((skill, index) => (
                <SkillRow key={`primary-${index}`} skill={skill} isGranted={skill.id ? grantedIds.has(skill.id) : false} />
              ))}
          ...
          <div>
            ...
            <div className="divide-y divide-stone-200 dark:divide-stone-700 rounded-md border border-stone-200 dark:border-stone-700 overflow-hidden">
              {secondarySkills.map((skill, index) => (
                <SkillRow key={`secondary-${index}`} skill={skill} isGranted={skill.id ? grantedIds.has(skill.id) : false} />
              ))}
